...
- **Output**: a single markdown file at `docs/test-plans/<branch-slug>.md`. Create the `docs/test-plans/` directory if missing.
...
- Do not modify any source files. Only write the test plan markdown file.
